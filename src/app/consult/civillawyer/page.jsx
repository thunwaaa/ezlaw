  ...
  return (
    <div className='bg-blue-200 p-10 h-screen'>
      <div className='rounded-2xl mt-10 w-11/12 h-auto  bg-white  p-20 mx-10 flex justify-between text-left items-center'>
        ...
        <NavigationMenuList>
          <NavigationMenuItem>
            <NavigationMenuTrigger><Link href = '/consult/civillawyer'>แพ่งและพาณิชย์</Link></NavigationMenuTrigger>
...
export default ConsultCivilLawyer